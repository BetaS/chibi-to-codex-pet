...
**Reason**: 사용자가 ZIP 다운로드를 누르기 전에도 완성된 Pet 직후 contextual 안내를 볼 수 있도록 노출 시점을 앞당긴다.

**Migration**: `Pet 생성 완료 직후 Star 안내` 요구사항이 첫 성공 직후의 1회 노출을 소유하고, 다운로드 링크는 Blob 다운로드와 기존 분석 이벤트만 유지한다.
